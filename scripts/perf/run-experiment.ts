...
const EXPERIMENTS: ExperimentDefinition[] = [
  ...
  {
    id: 'rust-trace-event-import',
    label: 'Rust trace-event import',
    description:
      'Experimental path that routes trace-event queue ordering through Rust/WASM with a TypeScript fallback.',
    flags: {
      deferDemangle: false,
      optimizedForEachCall: false,
      rustFuzzyFind: false,
