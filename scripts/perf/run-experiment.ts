...
import {BrowserBenchmarkReport, EngineRunOptions, ParityReport} from './types'
...
const EXPERIMENTS: ExperimentDefinition[] = [
  {
    id: 'legacy',
    label: 'Legacy engine',
    description: 'Current default import engine. This remains the oracle and visible result.',
    engine: {
      name: 'legacy',
      importEngine: 'legacy',
      compareImport: false,
      visibleImportEngine: 'legacy',
    },
  },
  {
    id: 'experimental',
    label: 'Experimental engine',
    description:
      'Experimental import engine that routes the existing Rust-backed importer work behind one engine seam.',
    engine: {
      name: 'experimental',
      importEngine: 'experimental',
      compareImport: false,
      visibleImportEngine: 'experimental',
    },
  },
  {
    id: 'experimental-compare',
    label: 'Experimental compare mode',
    description:
      'Legacy stays visible while the experimental engine runs as a background comparison pass and reports mismatches.',
    engine: {
      name: 'experimental-compare',
      importEngine: 'experimental',
      compareImport: true,
      visibleImportEngine: 'legacy',
    },
